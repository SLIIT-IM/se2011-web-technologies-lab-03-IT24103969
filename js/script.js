...
contactForm.onsubmit = function(event){
	...
	if(fullName === "" || email ==="" || phone ==="" || message ===""){
		...
		formMessage.textContent = "Phone number should contain atleast 10 characters";
		formMessage.style.color = "red";		
...
window.onload = function(){
	document.getElementById("welcomeMessage").textContent = "Page loaded successfully! Click buttons to interact with the website";
};
